...
from utils.dataset_train import Sketchy
...
if __name__ == '__main__':
    ...
    val_dataset = Sketchy(opts, dataset_transforms, mode='val', used_cat=train_dataset.all_categories,
                          return_orig=False)
    ...
    logger = TensorBoardLogger('./checkpoints/tb_logs', name='Sketchy/')
    dirpath = './checkpoints/saved_models/%s' % 'Sketchy/'
    print(dirpath)
    ...
    ckpt_path = os.path.join('./checkpoints/saved_models/', 'Sketchy/', 'last.ckpt')
