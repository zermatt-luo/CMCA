...
from utils.dataset_evaluation import QuickDrawDataset
...
ckpt_path = './checkpoints/saved_models/QuickDraw/epoch=00-top10=0.00.ckpt'
...
quickdraw_zero_ext = QuickDrawDataset(split='zero', version='all_photo', zero_version='zeroshot',
                                      transform=transformations, aug=False)
zero_loader_ext = DataLoader(dataset=quickdraw_zero_ext, batch_size=80, shuffle=False, num_workers=0)

quickdraw_zero = QuickDrawDataset(split='zero', zero_version='zeroshot', transform=transformations, aug=False)
zero_loader = DataLoader(dataset=quickdraw_zero, batch_size=80, shuffle=False, num_workers=0)
